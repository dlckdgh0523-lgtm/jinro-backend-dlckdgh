...
function CompletionStatus({ go }) {
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "toss-scroll", style: { flex: 1, overflow: "auto", padding: 28, background: "var(--bg-canvas)" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginBottom: 16 } }, /* @__PURE__ */ React.createElement(MetricCard, { label: "\uD559\uAE09 \uD3C9\uADE0 \uC644\uB8CC\uC728", value: `${classAvg}%`, delta: "+8 \uC9C0\uB09C\uC8FC", deltaTone: "success", icon: /* @__PURE__ */ React.createElement(IcCheck, { size: 16 }) }), /* @__PURE__ */ React.createElement(MetricCard, { label: "100% \uC644\uB8CC", value: `${completed}\uBA85`, delta: "\uC798\uD558\uB294 \uD559\uC0DD", deltaTone: "success", icon: /* @__PURE__ */ React.createElement(IcStar, { size: 16 }) }), /* @__PURE__ */ React.createElement(MetricCard, { label: "\uC9C4\uD589 \uC911", value: `${students.length - completed - risk}\uBA85`, delta: "\uC815\uC0C1 \uD398\uC774\uC2A4", deltaTone: "info", icon: /* @__PURE__ */ React.createElement(IcZap, { size: 16 }) }), /* @__PURE__ */ React.createElement(MetricCard, { label: "\uC8FC\uC758 \uD544\uC694", value: `${risk}\uBA85`, delta: "40% \uBBF8\uB9CC", deltaTone: "danger", icon: /* @__PURE__ */ React.createElement(IcAlert, { size: 16 }) })), /* @__PURE__ */ React.createElement(SectionCard, { title: "\uD559\uC0DD\uBCC4 \uC9C4\uD589\uB960", subtitle: "\uC644\uB8CC\uC728 \uB192\uC740 \uC21C" }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column" } }, students.map((s, i, arr) => {
