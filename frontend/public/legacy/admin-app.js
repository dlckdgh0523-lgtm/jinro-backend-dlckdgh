...
function AdminDashboard({ go }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", height: "100%" } }, /* @__PURE__ */ React.createElement(AdminTopbar, { title: "\uC6B4\uC601 \uB300\uC2DC\uBCF4\uB4DC", subtitle: "\uC2E4\uC2DC\uAC04 \uC9D1\uACC4 \uAE30\uC900" }), /* @__PURE__ */ React.createElement("div", { className: "toss-scroll", style: { flex: 1, overflow: "auto", padding: 24, background: "var(--bg-canvas)" } }, loading ? /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: isMobile ? "repeat(2, 1fr)" : "repeat(6, 1fr)", gap: 12, marginBottom: 16 } }, [0, 1, 2, 3, 4, 5].map((i) => /* @__PURE__ */ React.createElement(Card, { key: i, padding: 18 }, /* @__PURE__ */ React.createElement(Skeleton, { width: "60%", height: 12 }), /* @__PURE__ */ React.createElement(Skeleton, { width: "40%", height: 24, style: { marginTop: 12 } })))) : /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: isMobile ? "repeat(2, 1fr)" : "repeat(6, 1fr)", gap: 12, marginBottom: 16 } }, /* @__PURE__ */ React.createElement(MetricCard, { label: "\uCD1D \uC0AC\uC6A9\uC790", value: n(u.total), icon: /* @__PURE__ */ React.createElement(IcUsers, { size: 16 }) }), /* @__PURE__ */ React.createElement(MetricCard, { label: "\uD559\uC0DD", value: n(u.students), icon: /* @__PURE__ */ React.createElement(IcUser, { size: 16 }) }), /* @__PURE__ */ React.createElement(MetricCard, { label: "\uAD50\uC0AC", value: n(u.teachers), icon: /* @__PURE__ */ React.createElement(IcGraduation, { size: 16 }) }), /* @__PURE__ */ React.createElement(MetricCard, { label: "AI \uC138\uC158", value: n(ai.sessions), icon: /* @__PURE__ */ React.createElement(IcSparkles, { size: 16 }) }), /* @__PURE__ */ React.createElement(MetricCard, { label: "\uB9AC\uD3EC\uD2B8", value: n(ai.reports), icon: /* @__PURE__ */ React.createElement(IcStar, { size: 16 }) }), /* @__PURE__ */ React.createElement(MetricCard, { label: "\uD559\uACFC \uB370\uC774\uD130", value: n(c.departments), icon: /* @__PURE__ */ React.createElement(IcServer, { size: 16 }) })), !loading && /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: isMobile ? "repeat(2, 1fr)" : "repeat(4, 1fr)", gap: 12, marginBottom: 16 } }, /* @__PURE__ */ React.createElement(MetricCard, { label: "\uD65C\uC131 \uC0AC\uC6A9\uC790", value: n(u.active), icon: /* @__PURE__ */ React.createElement(IcUsers, { size: 16 }) }), /* @__PURE__ */ React.createElement(MetricCard, { label: "\uBD09\uC0AC \uB370\uC774\uD130", value: n(c.volunteers), icon: /* @__PURE__ */ React.createElement(IcMessage, { size: 16 }) }), /* @__PURE__ */ React.createElement(MetricCard, { label: "\uC7A5\uD559\uAE08 \uB370\uC774\uD130", value: n(c.scholarships), icon: /* @__PURE__ */ React.createElement(IcCreditCard, { size: 16 }) }), /* @__PURE__ */ React.createElement(MetricCard, { label: "\uD574\uC678\uB300\uD559 \uB370\uC774\uD130", value: n(c.foreignUniv), icon: /* @__PURE__ */ React.createElement(IcGraduation, { size: 16 }) })), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: isMobile ? "1fr" : "2fr 1fr", gap: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 16 } }, /* @__PURE__ */ React.createElement(
    SectionCard,
    {
      title: "\uCD5C\uADFC AI \uC0C1\uB2F4 \uC138\uC158",
...
function AdminUsers() {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", height: "100%" } }, /* @__PURE__ */ React.createElement(
  ...
  ), /* @__PURE__ */ React.createElement("div", { style: { padding: isMobile ? "14px 16px 8px" : "16px 24px 12px", display: "flex", gap: 12, alignItems: "center", background: "var(--bg-canvas)", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(TextInput, { value: q, onChange: setQ, placeholder: "\uC774\uB984, \uC774\uBA54\uC77C \uAC80\uC0C9", leading: /* @__PURE__ */ React.createElement(IcSearch, { size: 16 }), style: { flex: 1, minWidth: isMobile ? 140 : 0, maxWidth: isMobile ? "100%" : 320, height: 40 } }), /* @__PURE__ */ React.createElement(Tabs, { items: [
    { id: "all", label: "\uC804\uCCB4" },
    { id: "student", label: "\uD559\uC0DD" },
    { id: "teacher", label: "\uAD50\uC0AC" },
    { id: "admin", label: "\uAD00\uB9AC\uC790" }
  ], activeId: role, onChange: setRole })), /* @__PURE__ */ React.createElement("div", { className: "toss-scroll", style: { flex: 1, overflow: "auto", padding: isMobile ? "0 12px 20px" : "0 24px 24px", background: "var(--bg-canvas)" } }, /* @__PURE__ */ React.createElement(Card, { padding: 0, style: { minWidth: isMobile ? 0 : 880 } }, /* @__PURE__ */ React.createElement("div", { style: {
    ...
    flexDirection: "column",
    gap: 8
  } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12 } }, /* @__PURE__ */ React.createElement(Avatar, { name: (u.name || "?").slice(0, 1), size: 32 }), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 700, color: "var(--fg-strong)" } }, u.name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--fg-muted)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, u.email)), roleChip(u.role), /* @__PURE__ */ React.createElement(IcChevronRight, { size: 16, color: "var(--fg-subtle)" })), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", alignItems: "center", gap: 8, fontSize: 12, color: "var(--fg-muted)" } }, statusChip(u.status), /* @__PURE__ */ React.createElement("span", null, [u.school, u.classroom].filter(Boolean).join(" \xB7 ") || "\uD559\uAD50 \uBBF8\uC815"), /* @__PURE__ */ React.createElement("span", { className: "num" }, "\xB7 ", fmtDate(u.createdAt)))) : /* @__PURE__ */ React.createElement(
    "div",
    {
      key: u.id,
...
function AdminAuditLogs() {
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "toss-scroll", style: { flex: 1, overflow: "auto", padding: isMobile ? "12px" : 24, background: "var(--bg-canvas)" } }, /* @__PURE__ */ React.createElement(Card, { padding: 0, style: { minWidth: isMobile ? 0 : 820 } }, /* @__PURE__ */ React.createElement("div", { style: { display: isMobile ? "none" : "grid", gridTemplateColumns: "170px 120px 1.6fr 1.4fr", padding: "12px 20px", fontSize: 11, fontWeight: 700, color: "var(--fg-muted)", textTransform: "uppercase", letterSpacing: 0.3, borderBottom: "1px solid var(--line-subtle)" } }, /* @__PURE__ */ React.createElement("span", null, "\uC2DC\uAC01"), /* @__PURE__ */ React.createElement("span", null, "\uC870\uCE58"), /* @__PURE__ */ React.createElement("span", null, "\uB0B4\uC6A9"), /* @__PURE__ */ React.createElement("span", null, "\uC218\uD589\uC790 \xB7 \uC0AC\uC720")), loading ? [0, 1, 2, 3, 4].map((i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { padding: "14px 20px", borderBottom: "1px solid var(--line-subtle)" } }, /* @__PURE__ */ React.createElement(Skeleton, { width: "55%", height: 14 }))) : list.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { padding: 24 } }, /* @__PURE__ */ React.createElement(EmptyState, { icon: /* @__PURE__ */ React.createElement(IcDoc, { size: 22 }), title: "\uAE30\uB85D\uB41C \uAC10\uC0AC \uB85C\uADF8\uAC00 \uC5C6\uC5B4\uC694", body: "\uAD00\uB9AC\uC790\uAC00 \uACC4\uC815\uC744 \uBE44\uD65C\uC131\uD654\xB7\uD65C\uC131\uD654\xB7\uC0DD\uC131\uD558\uBA74 \uC0AC\uC720\uC640 \uD568\uAED8 \uC5EC\uAE30\uC5D0 \uAE30\uB85D\uB3FC\uC694." })) : list.map((a, i) => {
    const meta = auditActionMeta(a.action);
    return isMobile ? /* @__PURE__ */ React.createElement("div", { key: a.id || i, style: { padding: "12px 16px", borderBottom: i < list.length - 1 ? "1px solid var(--line-subtle)" : "none", display: "flex", flexDirection: "column", gap: 6 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 } }, /* @__PURE__ */ React.createElement(Chip, { tone: meta.tone, size: "sm" }, meta.label), /* @__PURE__ */ React.createElement("span", { className: "num", style: { fontSize: 11, color: "var(--fg-muted)" } }, fmtDateTime(a.createdAt))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "var(--fg-strong)" }, className: "kr-heading" }, a.summary), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--fg-muted)" } }, a.actor, a.reason ? ` \xB7 ${a.reason}` : "")) : /* @__PURE__ */ React.createElement("div", { key: a.id || i, style: { display: "grid", gridTemplateColumns: "170px 120px 1.6fr 1.4fr", padding: "14px 20px", alignItems: "center", fontSize: 13, borderBottom: i < list.length - 1 ? "1px solid var(--line-subtle)" : "none" } }, /* @__PURE__ */ React.createElement("span", { className: "num", style: { fontSize: 12, color: "var(--fg-muted)" } }, fmtDateTime(a.createdAt)), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(Chip, { tone: meta.tone, size: "sm" }, meta.label)), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--fg-strong)" }, className: "kr-heading" }, a.summary), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--fg-muted)", fontSize: 12 } }, a.actor, a.reason ? ` \xB7 ${a.reason}` : ""));
  }))));
}
function AdminSystem() {
  ...
  if (err) {
    ...
    ), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", background: "var(--bg-canvas)", padding: 24 } }, /* @__PURE__ */ React.createElement(Card, { padding: 32, style: { width: "100%", maxWidth: 480, textAlign: "center" } }, /* @__PURE__ */ React.createElement(
      EmptyState,
      {
