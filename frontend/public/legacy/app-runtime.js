...
function SidebarDrawer({ open, onClose, children }) {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, open && /* @__PURE__ */ React.createElement("div", { onClick: onClose, style: { position: "absolute", inset: 0, background: "rgba(17,24,39,0.45)", zIndex: 199 } }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: 0, left: 0, height: "100%", maxHeight: "100%", overflowY: "auto", WebkitOverflowScrolling: "touch", zIndex: 200, transform: open ? "translateX(0)" : "translateX(-105%)", transition: "transform .26s var(--ease-toss, ease)", boxShadow: open ? "0 0 40px rgba(0,0,0,0.3)" : "none" } }, children));
}
function LiveRunner() {
  const initialRole = (() => {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { height: "100dvh", display: "flex", flexDirection: "column", background: "#E9ECEF" } }, showDevBar && /* @__PURE__ */ React.createElement("div", { style: {
    ...
    alignItems: "center",
    gap: 4
  } }, /* @__PURE__ */ React.createElement(IcRefresh, { size: 12 }), " \uC0C1\uD0DC \uCD08\uAE30\uD654")), /* @__PURE__ */ React.createElement("div", { className: "toss-scroll", style: { flex: 1, overflow: "auto", display: "flex", justifyContent: "center", alignItems: "stretch", padding: width === 0 ? 0 : "16px 0" } }, /* @__PURE__ */ React.createElement("div", { key: role + ":" + remount, style: { ...frameStyle, minWidth: 0, maxWidth: "100%", background: "var(--bg-canvas)", overflowX: "hidden", overflowY: "auto", WebkitOverflowScrolling: "touch", display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React.createElement(AuthProvider, { role: role.startsWith("teacher") ? "teacher" : role === "admin" ? "admin" : "student" }, role === "auth-mobile" ? /* @__PURE__ */ React.createElement(MobileAuthApp, { onEnter: handleAuthComplete }) : role === "onboarding" ? /* @__PURE__ */ React.createElement(OnboardingFlow, { role: onbRole, onFinish: finishOnboarding }) : roleCfg.render()))), typeof OAuthOnboarding === "function" && /* @__PURE__ */ React.createElement(OAuthOnboarding, null));
}
