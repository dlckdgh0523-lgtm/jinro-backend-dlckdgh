...
function AuthScreen({ role = "student", mode = "login", onNav, onBack, setRole, setMode }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    window.location.href = "/v1/auth/google/start" + (isTeacher ? "?role=teacher" : "");
  } }, "Google\uB85C ", isSignup ? "\uC2DC\uC791\uD558\uAE30" : "\uB85C\uADF8\uC778", isSignup && isTeacher ? " (\uAD50\uC0AC)" : ""), /* @__PURE__ */ React.createElement(Button, { variant: "outline", size: "lg", full: true, leading: /* @__PURE__ */ React.createElement(IcKakao, { size: 18 }), style: { marginBottom: 20, background: "#FEE500", borderColor: "#FEE500" }, onClick: () => {
    window.location.href = "/v1/auth/kakao/start" + (isTeacher ? "?role=teacher" : "");
