...
function PaymentResult({ status = "success" }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { minHeight: "100%", background: "var(--bg-canvas)", display: "flex", alignItems: "center", justifyContent: "center", padding: 40 } }, /* @__PURE__ */ React.createElement(Card, { padding: 40, style: { width: 480, textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: {
    width: 72,
    height: 72,
    borderRadius: 20,
