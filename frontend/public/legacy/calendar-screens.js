...
function TeacherCalendar({ openNotif }) {
  ...
  ), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "grid", gridTemplateColumns: isMobile ? "1fr" : "2fr 1fr", background: "var(--bg-canvas)", minHeight: 0, padding: isMobile ? 12 : 24, gap: isMobile ? 12 : 16, overflowY: isMobile ? "auto" : "hidden" } }, /* @__PURE__ */ React.createElement(Card, { padding: 20, style: { overflow: "auto" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "num", style: { fontSize: 22, fontWeight: 800, color: "var(--fg-strong)" } }, monthLabel), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4 } }, /* @__PURE__ */ React.createElement(Button, { variant: "outline", size: "sm", onClick: () => {
