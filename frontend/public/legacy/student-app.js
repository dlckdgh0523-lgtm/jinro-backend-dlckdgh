...
function AICounseling({ go, openSignals }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", height: "100%", background: "var(--bg-canvas)" } }, /* @__PURE__ */ React.createElement("div", { style: {
    ...
    const hint = stage === "explore" ? `\uB2E8\uC11C\uB97C ${Math.max(1, 2 - signals.length)}\uAC1C \uB354 \uBAA8\uC73C\uBA74 \u2018\uD30C\uC545\u2019 \uB2E8\uACC4\uB85C \uB118\uC5B4\uAC00\uC694` : stage === "profile" ? `\uB2E8\uC11C\uB97C ${Math.max(1, 4 - signals.length)}\uAC1C \uB354 \uBAA8\uC73C\uBA74 \u2018\uCD94\uCC9C\u2019 \uB2E8\uACC4\uB85C \uB118\uC5B4\uAC00\uC694` : stage === "recommend" ? `\uB9C8\uC74C\uC5D0 \uB4DC\uB294 \uC9C4\uB85C\uB97C \u2018\uC9C4\uB85C \uBAA9\uD45C\u2019\uB85C \uC800\uC7A5\uD558\uBA74 \u2018\uC900\uBE44\u2019 \uB2E8\uACC4\uB85C \uB118\uC5B4\uAC00\uC694` : `\uC785\uC2DC\xB7\uC131\uC801\uACFC \uC5F0\uACB0\uD574 \uC0C1\uB2F4\uC744 \uB9C8\uBB34\uB9AC\uD574\uC694`;
