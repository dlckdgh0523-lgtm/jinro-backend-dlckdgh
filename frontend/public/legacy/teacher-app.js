...
function TeacherDashboard({ go, openNotif }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", height: "100%" } }, /* @__PURE__ */ React.createElement(TeacherTopbar, { help: "teacher-dashboard", title: "\uC88B\uC740 \uC544\uCE68\uC774\uC5D0\uC694, \uC120\uC0DD\uB2D8", subtitle: "\uC624\uB298 \uD559\uAE09\uC5D0\uC11C \uC8FC\uBAA9\uD560 \uD559\uC0DD\uC744 \uC815\uB9AC\uD588\uC5B4\uC694.", openNotif }), /* @__PURE__ */ React.createElement("div", { className: "toss-scroll", style: { flex: 1, overflow: "auto", padding: 28, background: "var(--bg-canvas)" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: isMobile ? "repeat(2, 1fr)" : "repeat(4, 1fr)", gap: 12, marginBottom: 16 } }, /* @__PURE__ */ React.createElement(MetricCard, { label: "\uCD1D \uD559\uC0DD", value: loading ? "\u2013" : String(total), hint: (meta == null ? void 0 : meta.classroom) || void 0, icon: /* @__PURE__ */ React.createElement(IcUsers, { size: 16 }) }), /* @__PURE__ */ React.createElement(MetricCard, { label: "\uC774\uBC88 \uC8FC \uD65C\uB3D9", value: loading ? "\u2013" : `${activeCount}\uBA85`, delta: activeCount > 0 ? "\uD65C\uC131" : void 0, deltaTone: "success", icon: /* @__PURE__ */ React.createElement(IcZap, { size: 16 }) }), /* @__PURE__ */ React.createElement(MetricCard, { label: "\uC0C1\uB2F4 \uD544\uC694", value: loading ? "\u2013" : `${needsCount}\uBA85`, delta: needsCount > 0 ? "\uD655\uC778 \uD544\uC694" : void 0, deltaTone: "warning", icon: /* @__PURE__ */ React.createElement(IcMessage, { size: 16 }) }), /* @__PURE__ */ React.createElement(MetricCard, { label: "\uD3C9\uADE0 \uC9C4\uD589\uB3C4", value: loading ? "\u2013" : `${avgProgress}%`, delta: "AI \uC0C1\uB2F4 \uAE30\uC900", deltaTone: "success", icon: /* @__PURE__ */ React.createElement(IcChart, { size: 16 }) })), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: isMobile ? "1fr" : "2fr 1fr", gap: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 16 } }, /* @__PURE__ */ React.createElement(
    SectionCard,
    {
      title: "\uC624\uB298 \uC8FC\uBAA9\uD560 \uD559\uC0DD",
...
function TeacherClassroom({ go, openNotif }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", height: "100%" } }, /* @__PURE__ */ React.createElement(TeacherTopbar, { help: "teacher-classroom", title: "\uC6B0\uB9AC \uD559\uAE09", subtitle: `${classroomLabel} \xB7 ${loading ? "\u2026" : count}\uBA85`, openNotif }), /* @__PURE__ */ React.createElement("div", { className: "toss-scroll", style: { flex: 1, overflow: "auto", padding: 28, background: "var(--bg-canvas)" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.4fr 1fr", gap: 16, marginBottom: 16 } }, /* @__PURE__ */ React.createElement(Card, { padding: 28, style: {
  ...
  )), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" } }, /* @__PURE__ */ React.createElement("div", { className: "num", style: { fontSize: 38, fontWeight: 800, color: "var(--fg-strong)", letterSpacing: "-1px" } }, loading ? "\u2013" : count), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--fg-muted)" } }, "/30\uBA85"))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginTop: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { padding: 12, background: "var(--bg-muted)", borderRadius: 10, textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--fg-muted)" } }, "\uD3C9\uADE0 \uC9C4\uD589\uB3C4"), /* @__PURE__ */ React.createElement("div", { className: "num", style: { fontSize: 20, fontWeight: 800, color: "var(--brand-600)" } }, loading ? "\u2013" : `${avgProgress}%`)), /* @__PURE__ */ React.createElement("div", { style: { padding: 12, background: "var(--bg-muted)", borderRadius: 10, textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--fg-muted)" } }, "\uD3C9\uADE0 \uC131\uC801"), /* @__PURE__ */ React.createElement("div", { className: "num", style: { fontSize: 20, fontWeight: 800, color: "var(--fg-strong)" } }, loading ? "\u2013" : avgGrade == null ? "\uBBF8\uC785\uB825" : avgGrade))))), /* @__PURE__ */ React.createElement(SectionCard, { title: "\uD559\uAE09 \uD559\uC0DD", action: /* @__PURE__ */ React.createElement(Button, { variant: "ghost", size: "sm", onClick: () => go("students"), trailing: /* @__PURE__ */ React.createElement(IcChevronRight, { size: 14 }) }, "\uC804\uCCB4 \uD559\uC0DD \uBCF4\uAE30") }, loading ? /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: isMobile ? "repeat(2, 1fr)" : "repeat(3, 1fr)", gap: 12 } }, [0, 1, 2, 3, 4, 5].map((i) => /* @__PURE__ */ React.createElement(Skeleton, { key: i, height: 64, radius: 12 }))) : rows.length === 0 ? /* @__PURE__ */ React.createElement(EmptyState, { icon: /* @__PURE__ */ React.createElement(IcUsers, { size: 24 }), title: "\uC544\uC9C1 \uB4F1\uB85D\uB41C \uD559\uAE09 \uD559\uC0DD\uC774 \uC5C6\uC5B4\uC694", body: "\uD559\uAE09 \uCD08\uB300\uCF54\uB4DC\uB97C \uACF5\uC720\uD574 \uCCAB \uD559\uC0DD\uC744 \uCD08\uB300\uD574\uBCF4\uC138\uC694." }) : /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: isMobile ? "repeat(2, 1fr)" : "repeat(3, 1fr)", gap: 12 } }, rows.map((s) => /* @__PURE__ */ React.createElement("div", { key: s.id, onClick: () => openStudentDetail(go, s.id), style: {
    padding: 14,
    border: "1px solid var(--line-subtle)",
    borderRadius: 12,
    display: "flex",
...
function TeacherStudents({ go, openNotif }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", height: "100%" } }, /* @__PURE__ */ React.createElement(
    ...
    flexDirection: "column",
    gap: 10
  } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12 } }, /* @__PURE__ */ React.createElement(Avatar, { name: (s.name || "?").slice(0, 1), size: 36 }), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, fontWeight: 700, color: "var(--fg-strong)", display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" } }, s.name, s.needsCounseling && /* @__PURE__ */ React.createElement(Chip, { tone: "warning", size: "sm", style: { height: 18, padding: "0 6px", fontSize: 10 } }, "\uC0C1\uB2F4 \uD544\uC694")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--fg-muted)" } }, s.grade || "\uD559\uB144 \uBBF8\uC815")), /* @__PURE__ */ React.createElement(IcChevronRight, { size: 16, color: "var(--fg-subtle)" })), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { background: "var(--bg-muted)", borderRadius: 10, padding: "8px 10px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "var(--fg-muted)", marginBottom: 3 } }, "\uCD5C\uADFC \uD3C9\uADE0"), s.gradeAverage == null ? /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: "var(--fg-subtle)" } }, "\uBBF8\uC785\uB825") : /* @__PURE__ */ React.createElement("span", { className: "num", style: { fontSize: 15, fontWeight: 700, color: "var(--fg-strong)" } }, s.gradeAverage)), /* @__PURE__ */ React.createElement("div", { style: { background: "var(--bg-muted)", borderRadius: 10, padding: "8px 10px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "var(--fg-muted)", marginBottom: 3 } }, "AI \uC9C4\uD589\uB3C4"), aiProgressBadge(s.aiProgress || 0)), /* @__PURE__ */ React.createElement("div", { style: { background: "var(--bg-muted)", borderRadius: 10, padding: "8px 10px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "var(--fg-muted)", marginBottom: 3 } }, "\uD559\uC2B5 \uC9C4\uB3C4"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement(ProgressBar, { value: s.studyDone, max: Math.max(s.studyTotal, 1), height: 5 }), /* @__PURE__ */ React.createElement("span", { className: "num", style: { fontSize: 11, color: "var(--fg-muted)", minWidth: 28, textAlign: "right" } }, s.studyDone, "/", s.studyTotal))), /* @__PURE__ */ React.createElement("div", { style: { background: "var(--bg-muted)", borderRadius: 10, padding: "8px 10px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "var(--fg-muted)", marginBottom: 3 } }, "\uB9C8\uC9C0\uB9C9 \uD65C\uB3D9"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "var(--fg-subtle)" } }, fmtActivity(s.lastActivityAt))))) : /* @__PURE__ */ React.createElement("div", { key: s.id, onClick: () => openStudentDetail(go, s.id), style: {
    display: "grid",
    gridTemplateColumns: "2fr 1.2fr 1.4fr 1.2fr 1.4fr 36px",
    padding: "14px 20px",
    alignItems: "center",
...
function TeacherStudentGrades({ grades }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 16 } }, terms.map((t) => /* @__PURE__ */ React.createElement(SectionCard, { key: t.term, title: t.term, action: t.avg != null && /* @__PURE__ */ React.createElement(Chip, { tone: "info", size: "sm" }, "\uD3C9\uADE0 ", t.avg) }, /* @__PURE__ */ React.createElement(Card, { padding: 0 }, /* @__PURE__ */ React.createElement("div", { style: { display: isMobile ? "none" : "grid", gridTemplateColumns: "1.4fr 1fr 1fr 1fr", padding: "10px 16px", fontSize: 11, fontWeight: 700, color: "var(--fg-muted)", borderBottom: "1px solid var(--line-subtle)" } }, /* @__PURE__ */ React.createElement("span", null, "\uACFC\uBAA9"), /* @__PURE__ */ React.createElement("span", null, "\uBD84\uB958"), /* @__PURE__ */ React.createElement("span", null, "\uC810\uC218"), /* @__PURE__ */ React.createElement("span", null, "\uB4F1\uAE09")), t.items.map((g, i) => isMobile ? /* @__PURE__ */ React.createElement("div", { key: g.id || i, style: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10, padding: "12px 16px", borderBottom: i < t.items.length - 1 ? "1px solid var(--line-subtle)" : "none" } }, /* @__PURE__ */ React.createElement("div", { style: { minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, fontWeight: 700, color: "var(--fg-strong)" } }, g.subject), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--fg-muted)" } }, g.category || "-")), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "right", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "num", style: { fontSize: 14, fontWeight: 700, color: "var(--fg-strong)" } }, g.score == null ? "-" : g.score + "\uC810"), /* @__PURE__ */ React.createElement("div", { className: "num", style: { fontSize: 11, color: "var(--fg-muted)" } }, g.rank == null ? "-" : g.rank + "\uB4F1\uAE09"))) : /* @__PURE__ */ React.createElement("div", { key: g.id || i, style: { display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr 1fr", padding: "12px 16px", alignItems: "center", fontSize: 13, borderBottom: i < t.items.length - 1 ? "1px solid var(--line-subtle)" : "none" } }, /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 700, color: "var(--fg-strong)" } }, g.subject), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--fg-muted)" } }, g.category || "-"), /* @__PURE__ */ React.createElement("span", { className: "num", style: { color: "var(--fg-strong)" } }, g.score == null ? "-" : g.score), /* @__PURE__ */ React.createElement("span", { className: "num", style: { color: "var(--fg-muted)" } }, g.rank == null ? "-" : g.rank)))))));
}
