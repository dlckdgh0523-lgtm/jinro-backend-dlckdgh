...
function TeacherMessages({ openNotif, go }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", height: "100%" } }, /* @__PURE__ */ React.createElement(
    ...
    !isMobile && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", minHeight: 0, background: "#EAF0F6" } }, /* @__PURE__ */ React.createElement(EmptyState, { icon: /* @__PURE__ */ React.createElement(IcMessage, { size: 24 }), title: "\uB300\uD654\uB97C \uC120\uD0DD\uD574\uC8FC\uC138\uC694", body: "\uC67C\uCABD \uBAA9\uB85D\uC5D0\uC11C \uD559\uC0DD\uC744 \uC120\uD0DD\uD558\uBA74 \uB300\uD654\uAC00 \uC5F4\uB824\uC694." }))
  ) : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", minHeight: 0, flex: isMobile ? 1 : "initial" } }, /* @__PURE__ */ React.createElement("div", { style: { padding: isMobile ? "12px 14px" : "14px 24px", borderBottom: "1px solid var(--line-subtle)", background: "var(--bg-surface)", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8, flexWrap: "wrap" } }, isMobile && /* @__PURE__ */ React.createElement("button", { onClick: () => setSelectedRaw(null), "aria-label": "\uBAA9\uB85D\uC73C\uB85C", style: { border: "none", background: "transparent", cursor: "pointer", padding: "4px 6px 4px 0", display: "flex", alignItems: "center" } }, /* @__PURE__ */ React.createElement(IcChevronLeft, { size: 20, color: "var(--fg-strong)" })), /* @__PURE__ */ React.createElement("button", { onClick: () => go && go("student-detail"), style: { display: "flex", alignItems: "center", gap: 12, border: "none", background: "transparent", cursor: go ? "pointer" : "default", padding: 0, textAlign: "left", minWidth: 0, flex: 1 } }, /* @__PURE__ */ React.createElement(Avatar, { name: (selected.otherName || "").slice(0, 1), size: 36 }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, fontWeight: 700, color: "var(--fg-strong)", display: "flex", alignItems: "center", gap: 4 } }, selected.otherName, /* @__PURE__ */ React.createElement(IcChevronRight, { size: 14, color: "var(--fg-subtle)" })), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--fg-muted)" } }, "\uD504\uB85C\uD544 \uBCF4\uAE30"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6 } }, /* @__PURE__ */ React.createElement(Button, { variant: "outline", size: "sm", leading: /* @__PURE__ */ React.createElement(IcDoc, { size: 14 }), onClick: () => go && go("student-detail") }, "\uD559\uC0DD \uD398\uC774\uC9C0"), /* @__PURE__ */ React.createElement(Button, { variant: "outline", size: "sm", leading: /* @__PURE__ */ React.createElement(IcCalendar, { size: 14 }), onClick: () => setBooking(true) }, "\uC0C1\uB2F4 \uC608\uC57D"))), /* @__PURE__ */ React.createElement("div", { ref: scrollRef, className: "toss-scroll", style: { flex: 1, overflow: "auto", padding: "16px 24px", display: "flex", flexDirection: "column", gap: 8, background: "#EAF0F6" } }, msgs === null ? /* @__PURE__ */ React.createElement(Skeleton, { height: 40 }) : msgs.length === 0 ? /* @__PURE__ */ React.createElement(DateDivider, { text: "\uCCAB \uBA54\uC2DC\uC9C0\uB97C \uBCF4\uB0B4\uBCF4\uC138\uC694" }) : msgs.map((m) => /* @__PURE__ */ React.createElement(
    MessageBubble,
    {
      key: m.id,
      side: m.mine ? "me" : "peer",
